...
@stop
@section('content')
<form method="POST" action="{!! route('user.update', $data['id'] ) !!}" name="editForm" accept-charset="UTF-8"
    ...
    <div class="form-group">
        ...
        <input type="text" required class="form-control" id="description" name="txtDescription"
            value="{{ old('txtDescription', isset($data['description']) ? $data['description'] : null ) }}">
    </div>
    <div class="form-group">
